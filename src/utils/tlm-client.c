        ...
        TlmLauncher *launcher)
{
    if (launcher) {
        ...
        g_free (launcher->app_path);
        g_free (launcher->app_args);
        g_free (launcher);
    }
}
        ...
        TlmLauncher *launcher)
{
    ...
    tlm_dbus_launcher_call_launch_app_sync (launcher_object, launcher->app_path,
            launcher->app_args?launcher->app_args:"", &appid, NULL, &error);
    if (error) {
...
int main (int argc, char *argv[])
{
    ...
    GOptionEntry main_entries[] =
    {
        ...
        { "launch-app", 'a', 0, G_OPTION_ARG_NONE, &is_launc_app_op,
                "launch app -- sessionid, and app_path are mandatory",
                NULL },
    ...
    GOptionEntry launch_entries[] =
    {
        ...
        { "apppath", 0, 0, G_OPTION_ARG_STRING, &launcher->app_path,
                "apppath", "path of app to launch" },
        { "appargs", 0, 0, G_OPTION_ARG_STRING, &launcher->app_args,
                "appargs", "args of app to launch" },
        { NULL }
    };
